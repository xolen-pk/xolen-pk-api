...
//   function to register user and send verification email to user
export const signup = async (req, res) => {
  ...
  try {
    ...
    const hashedPassword = await bcrypt.hash(password, 12); // hash the password with bcrypt and salt 12
    //
...
// getVerified function to verify user email and send token to frontend
...
// addWishlist function to add product to wishlist and callback token to frontend with data
...
// removeWishlist function to remove product from wishlist and callback token to frontend with data
...
// getCart function to get all products in cart and generate token to frontend with callback data
...
// addCart function to add product to cart and generate token to frontend with callback data
...
// removeCart function to remove product from cart and generate token to frontend with callback data(product removed from cart)
...
// cartQuantity function to increase or decrease quantity of product in cart and generate token to frontend with callback data(Updated cart)
...
// checkout function to send email to user and empty the cart after checkout is successful and return token to frontend.
// it stores the order in the database with user id and product id and quantity of product purchased by user
