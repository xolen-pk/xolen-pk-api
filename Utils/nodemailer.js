...
export const sendVerificationEmail = async (email, subject, text) => {
    try {
        ...
        const mailOptions = {
            from: `"Xolen.pk" <${process.env.USER}>`,
            to: email,
            subject: subject,
            text: text,
            html: `<html>
            <body>
                ...
                <div class="footer content" style="margin: 0 auto;width: fit-content;">
                    <p
                        ...
                        Xolen.pk, Your dream footwear store. Powerful, self-serve product and growth analytics to help you convert, engage, and retain more.</p>
                        ...
                        <p><a href=${process.env.BASE_URL} style="color: white; padding: 10px 10px 10px 10px; border:1px solid white; border-radius:16px; cursor: pointer; text-decoration: none;"> Xolen.pk For You</a></p>
                </div>
                <p style="padding: 10px 0px 10px 0px"> &copy; 2022 Xolen.pk. All rights reserved.</p>
            </div>
            </body>
        </html>`,
        };
            ...
            <body>
                ...
                <div class="footer content" style="margin: 0 auto;width: fit-content;">
                    <p style="margin-left: auto;margin-right: auto;color: white;font-size: small;">
                        Xolen.pk, Your dream footwear store. Powerful, self-serve product and growth analytics to help you convert, engage, and retain more.</p>
                    <p style="margin-left: auto;margin-right: auto; padding: 0px 0px 10px 0px;color: white;font-size: small;">Explore our collection of shoes, sandals, boots, sneakers, and more.</p>
                    <p><a href=${process.env.BASE_URL} style="color: white; padding: 10px 20px 10px 20px; border:1px solid white; border-radius:16px; cursor: pointer; text-decoration: none;"> Xolen.pk For You</a></p>
                </div>
                <p style="padding: 10px 0px 10px 0px"> &copy; 2022 Xolen.pk. All rights reserved.</p>
            </div>
            </body>
